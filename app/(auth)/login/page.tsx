            ...
            <div className="w-full max-w-[440px] rounded-[28px] glass-card p-8 sm:p-10 shadow-xl shadow-emerald-950/5 relative">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className="flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white py-2.5 px-3 text-xs font-semibold text-slate-700 hover:bg-slate-50 transition-colors shadow-2xs"
                >
